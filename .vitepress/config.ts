...
export default defineConfig({
  ...
  srcDir: "docs",
  head: [
    ['link', {'ref': 'icon', 'href': '/chatgpt.svg'}],
  ],
  themeConfig: {
    // https://vitepress.dev/reference/default-theme-config
    nav: [
      { text: 'Home', link: '/' },
      { text: 'Chat', link: 'https://chat.zhouxun.me' }
    ],
